...
namespace {
struct qt_meta_tag_ZN14TrackerBlockerE_t {};
} // unnamed namespace

template <> constexpr inline auto TrackerBlocker::qt_create_metaobjectdata<qt_meta_tag_ZN14TrackerBlockerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TrackerBlocker, qt_meta_tag_ZN14TrackerBlockerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject TrackerBlocker::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14TrackerBlockerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14TrackerBlockerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14TrackerBlockerE_t>.metaTypes,
    nullptr
} };
...
void *TrackerBlocker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14TrackerBlockerE_t>.strings))
